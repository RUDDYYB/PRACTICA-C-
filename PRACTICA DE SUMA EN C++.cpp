...
{
	int numero; // declaracion de la variable como entero
	numero = 5 + 5; // asignacon de la suma de 5+5 a la variable numero
	/*impresion del resultado de la variable numero y adicion al final 
	del salto de linea
*/
